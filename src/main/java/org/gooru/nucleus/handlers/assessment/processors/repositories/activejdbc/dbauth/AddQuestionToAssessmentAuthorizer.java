...
class AddQuestionToAssessmentAuthorizer implements Authorizer<AJEntityAssessment> {
    ...
    private ExecutionResult<MessageResponse> authorizeForQuestion(AJEntityAssessment assessment) {
        ...
        try {
            long count = Base.count(AJEntityQuestion.TABLE_QUESTION, AJEntityQuestion.QUESTION_FOR_ADD_FILTER,
        ...
        return new ExecutionResult<>(
            MessageResponseFactory
                .createInvalidRequestResponse(RESOURCE_BUNDLE.getString("question.not.available.for.association")),
            ExecutionResult.ExecutionStatus.FAILED);
    }
}
