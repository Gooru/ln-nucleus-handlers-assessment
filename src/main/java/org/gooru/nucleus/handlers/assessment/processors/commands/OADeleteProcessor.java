 ...
 */
class OADeleteProcessor extends AbstractCommandProcessor {

  public OADeleteProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    return RepoBuilder.buildAssessmentRepo(context).oaDelete();
  }
}
