...
class UpdateCollaboratorHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> checkSanity() {
    ...
    JsonObject errors = new DefaultPayloadValidator()
        .validatePayload(context.request(), AssessmentDao.editCollaboratorFieldSelector(),
  ...
  private JsonObject calculateDiffOfCollaborators() {
    ...
    String currentCollaboratorsAsString = this.assessment
        .getString(AJEntityAssessment.COLLABORATOR);
    ...
    JsonArray newCollaborators = this.context.request()
        .getJsonArray(AJEntityAssessment.COLLABORATOR);
