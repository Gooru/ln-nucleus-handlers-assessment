  ...
  private boolean deleteContents() {
    try {
      long deletedContentCount =
          Base.exec(AJEntityQuestion.DELETE_CONTENTS_QUERY, this.context.userId(),
              this.context.assessmentId());
      long deletedRubricCount =
          Base.exec(AJEntityRubric.DELETE_RUBRICS_QUERY, this.context.userId(),
              this.context.assessmentId());

      LOGGER.info("Assessment '{}' deleted along with '{}' questions and '{}' rubrics",
          context.assessmentId(),
