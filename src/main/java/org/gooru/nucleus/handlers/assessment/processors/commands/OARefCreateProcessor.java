 ...
 */
class OARefCreateProcessor extends AbstractCommandProcessor {

  public OARefCreateProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    return RepoBuilder.buildAssessmentRepo(context).oaRefCreate();
  }
}
