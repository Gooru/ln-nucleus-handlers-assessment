 ...
 */
class OARefDeleteProcessor extends AbstractCommandProcessor {

  public OARefDeleteProcessor(ProcessorContext context) {
    super(context);
  }
  ...
  protected MessageResponse processCommand() {
    ...
    return RepoBuilder.buildAssessmentRepo(context).oaRefDelete();
  }
}
