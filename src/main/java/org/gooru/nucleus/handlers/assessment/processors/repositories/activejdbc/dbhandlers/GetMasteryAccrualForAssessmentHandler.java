...
class GetMasteryAccrualForAssessmentHandler implements DBHandler {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(GetMasteryAccrualForAssessmentHandler.class);
    ...
    public ExecutionResult<MessageResponse> checkSanity() {
        ...
        if (assessmentIds == null || assessmentIds.isEmpty()) {
            ...
            return new ExecutionResult<>(MessageResponseFactory.createInvalidRequestResponse(
                RESOURCE_BUNDLE.getString("missing.assessment.ids")), ExecutionResult.ExecutionStatus.FAILED);
        }
    ...
    public ExecutionResult<MessageResponse> validateRequest() {
        LazyList<AJEntityAssessment> assessmentList =
            AJEntityAssessment.findBySQL(AJEntityAssessment.FETCH_ASSESSMENTS_EXTERNAL_ASMT_QUERY,
    ...
    private JsonArray mapAssessmentWithMasteryAccrualComp() throws SQLException {
        ...
        if (assessmentsGutCodes != null && !assessmentsGutCodes.isEmpty()) {
            ...
            List competencies = Base.firstColumn(FILTER_COMPS_FROM_GUT_CODES, gutCodesString, gutCodesString);
