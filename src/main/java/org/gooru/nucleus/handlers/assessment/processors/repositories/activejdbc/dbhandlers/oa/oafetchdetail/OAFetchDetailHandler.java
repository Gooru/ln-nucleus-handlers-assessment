...
public class OAFetchDetailHandler implements DBHandler {

  private static final Logger LOGGER = LoggerFactory.getLogger(OAFetchDetailHandler.class);
  private static final ResourceBundle RESOURCE_BUNDLE = ResourceBundle.getBundle("messages");
  private final OAProcessorContext context;
  private AJEntityAssessment offlineActivity;


  public OAFetchDetailHandler(ProcessorContext context) {
