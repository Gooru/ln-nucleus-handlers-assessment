...
class UpdateExternalAssessmentHandler implements DBHandler {
  ...
  private static final Logger LOGGER = LoggerFactory
      .getLogger(UpdateExternalAssessmentHandler.class);
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    return new ExecutionResult<>(
        MessageResponseFactory.createNoContentResponse(RESOURCE_BUNDLE.getString("updated"),
            EventBuilderFactory.getUpdateExAssessmentEventBuilder(context.assessmentId())),
  ...
  private static class DefaultAJEntityAssessmentEntityBuilder implements
      EntityBuilder<AJEntityAssessment> {
