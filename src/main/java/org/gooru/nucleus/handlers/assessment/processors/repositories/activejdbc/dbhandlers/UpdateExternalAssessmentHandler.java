 ...
 */
class UpdateExternalAssessmentHandler implements DBHandler {
  private static final Logger LOGGER = LoggerFactory.getLogger(UpdateExternalAssessmentHandler.class);
  private static final ResourceBundle RESOURCE_BUNDLE = ResourceBundle.getBundle("messages");
  private final ProcessorContext context;

  public UpdateExternalAssessmentHandler(ProcessorContext context) {
  ...
  public ExecutionResult<MessageResponse> checkSanity() {
    ...
    JsonObject errors = new DefaultPayloadValidator()
      .validatePayload(context.request(), AJEntityAssessment.editExFieldSelector(), AJEntityAssessment.getValidatorRegistry());
